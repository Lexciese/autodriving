...
class PreprocessingLidar(Preprocessing):
    ...
    def process(self):
        with torch.no_grad():
            ...
            self.bev_seg, self.bev_dep, self.front_seg, self.front_dep, self.rear_seg, self.rear_dep = self.gen_bev_front_rear_seg_dep(ptx_ten, pty_ten, ptz_ten, ptseg_ten, use_tensor=True)
